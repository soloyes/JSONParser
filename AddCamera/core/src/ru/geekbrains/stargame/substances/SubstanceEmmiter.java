...
public class SubstanceEmmiter {
    ...
    //Stages
    private static final int[] COUNT_FREE_SUBSTANCE = {60,40,20,10,100,80};
    ...
    public SubstanceEmmiter(World myWorld) {
    ...
    public void addSubstance() {
        ...
        while (substancePool.getActiveObjects().size() < COUNT_FREE_SUBSTANCE[currentStage]) {
            ...
            switch (Rnd.nextInt(1, 4)) {
                case HEAVY_TYPE:
                    this.generateSubstance(SubstanceEmmiter.HEAVY_TYPE);
                    break;
                case LIGHT_TYPE:
                    this.generateSubstance(SubstanceEmmiter.LIGHT_TYPE);
                    break;
                case MEDIUM_TYPE:
                    this.generateSubstance(SubstanceEmmiter.MEDIUM_TYPE);
            }
        }
    ...
    public List<Substance> getActiveSubstance() {
